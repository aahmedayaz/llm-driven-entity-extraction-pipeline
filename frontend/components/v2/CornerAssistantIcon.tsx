...
export function CornerAssistantIcon() {
  ...
  return (
    <div
      ...
      aria-label="About Ahmed Ayaz"
      onMouseEnter={openCard}
      onMouseLeave={closeCardAfterDelay}
    >
      <button
        type="button"
        className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-[#9fca72]/25 bg-[#6f8f4e]/15 text-[#9fca72] shadow-lg backdrop-blur transition hover:border-[#9fca72]/50 hover:bg-[#6f8f4e]/25"
      ...
      <div
        className={cn(
          "absolute right-0 top-full z-[300] w-64 pt-2",
      ...
      >
        <div
          role="dialog"
          className={cn(
            "rounded-2xl border border-[#9fca72]/20 bg-[rgba(20,20,19,0.92)] p-4 text-[var(--text-primary)] shadow-[var(--shadow-card)] backdrop-blur-xl transition duration-200",
            isCardOpen
        ...
        >
          ...
          <div className="mt-3 space-y-1.5 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2.5">
            <p className="text-[0.625rem] font-medium uppercase tracking-wide text-[#9fca72]">
              Built with
            </p>
            <p className="text-[0.6875rem] leading-relaxed text-[var(--text-secondary)]">
              <span className="text-[var(--text-primary)]">Frontend:</span>{" "}
              Next.js, React, TypeScript, Tailwind CSS
            </p>
            <p className="text-[0.6875rem] leading-relaxed text-[var(--text-secondary)]">
              <span className="text-[var(--text-primary)]">Backend:</span>{" "}
              FastAPI, Python
            </p>
          </div>
